...
def build_tool_schemas() -> list[dict[str, Any]]:
  ...
  schemas = [
    ...
    {"type": "function", "function": {"name": "get_host_environment", "description": "Detect host: comma C3/C3X/C4 or PC dev; hardware_profile includes Panda MCU, manager/pandad status, and pc_tools inventory.", "parameters": {"type": "object", "properties": {}, "required": []}}},
