...
EXTENSION_SCHEMAS: list[dict[str, Any]] = [
  ...
  {"type": "function", "function": {"name": "git_push", "description": "Git push to remote (confirm=true). Fork: auto GIT_LFS_SKIP_PUSH=1 (see ai/docs/GIT_LFS.md); set env GIT_LFS_SKIP_PUSH=0 to upload LFS.", "parameters": {"type": "object", "properties": {"remote": {"type": "string"}, "branch": {"type": "string"}, "set_upstream": {"type": "boolean"}, "confirm": {"type": "boolean"}}, "required": ["confirm"]}}},
  ...
  {"type": "function", "function": {"name": "tsk_start_can_collect", "description": "Offroad: start CAN oracle collection (stops manager and pandad). confirm=true required.", "parameters": {"type": "object", "properties": {"confirm": {"type": "boolean"}}, "required": []}}},
  ...
  {"type": "function", "function": {"name": "tsk_restart_pandad", "description": "Offroad: kill pandad process (unified on all comma devices). Black screen recovery. confirm=true required.", "parameters": {"type": "object", "properties": {"confirm": {"type": "boolean"}}, "required": []}}},
